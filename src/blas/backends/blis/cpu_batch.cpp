...
void gemm_batch(cl::sycl::queue &queue, cl::sycl::buffer<transpose, 1> &transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_sgemm_batch>(cgh, [=]() {
            ...
            gint_t *m_          = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *n_          = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *k_          = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *lda_        = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *ldb_        = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *ldc_        = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *group_size_ = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            ...
            ::sgemm_batch(transa_, transb_, m_, n_, k_, alpha_acc.get_pointer(),
                          ...
                          beta_acc.get_pointer(), c_array, ldc_, (gint_t *)&group_count,
                          group_size_);
...
void gemm_batch(cl::sycl::queue &queue, cl::sycl::buffer<transpose, 1> &transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_dgemm_batch>(cgh, [=]() {
            int64_t total_size = 0;
...
void gemm_batch(cl::sycl::queue &queue, cl::sycl::buffer<transpose, 1> &transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_cgemm_batch>(cgh, [=]() {
            int64_t total_size = 0;
            ...
            BLIS_Complex8 **a_array = (BLIS_Complex8 **)::malloc(sizeof(BLIS_Complex8 *) * total_size);
            BLIS_Complex8 **b_array = (BLIS_Complex8 **)::malloc(sizeof(BLIS_Complex8 *) * total_size);
            BLIS_Complex8 **c_array = (BLIS_Complex8 **)::malloc(sizeof(BLIS_Complex8 *) * total_size);
            gint_t *m_            = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *n_            = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *k_            = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *lda_          = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            ...
            ::cgemm_batch(transa_, transb_, m_, n_, k_, alpha_acc.get_pointer(),
                          (const BLIS_Complex8 **)a_array, lda_, (const BLIS_Complex8 **)b_array,
                          ldb_, beta_acc.get_pointer(), c_array, ldc_, (gint_t *)&group_count,
                          group_size_);
...
void gemm_batch(cl::sycl::queue &queue, cl::sycl::buffer<transpose, 1> &transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_zgemm_batch>(cgh, [=]() {
            int64_t total_size = 0;
            ...
            BLIS_Complex16 **a_array =
                (BLIS_Complex16 **)::malloc(sizeof(BLIS_Complex16 *) * total_size);
            BLIS_Complex16 **b_array =
                (BLIS_Complex16 **)::malloc(sizeof(BLIS_Complex16 *) * total_size);
            BLIS_Complex16 **c_array =
                (BLIS_Complex16 **)::malloc(sizeof(BLIS_Complex16 *) * total_size);
            gint_t *m_          = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *n_          = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            gint_t *k_          = (gint_t *)::malloc(sizeof(gint_t) * group_count);
            ...
            ::zgemm_batch(transa_, transb_, m_, n_, k_, alpha_acc.get_pointer(),
                          (const BLIS_Complex16 **)a_array, lda_, (const BLIS_Complex16 **)b_array,
                          ldb_, beta_acc.get_pointer(), c_array, ldc_, (gint_t *)&group_count,
                          group_size_);
...
void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_sgemm_batch_stride>(cgh, [=]() {
            ...
            ::sgemm_batch(&transa_, &transb_, (const gint_t *)&m, (const gint_t *)&n,
                          (const gint_t *)&k, &alpha, (const float **)a_array,
                          (const gint_t *)&lda, (const float **)b_array, (const gint_t *)&ldb,
                          &beta, c_array, (const gint_t *)&ldc, (const gint_t *)&one,
                          (const gint_t *)&batch_size);
...
void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_dgemm_batch_stride>(cgh, [=]() {
            ...
            ::dgemm_batch(&transa_, &transb_, (const gint_t *)&m, (const gint_t *)&n,
                          (const gint_t *)&k, &alpha, (const double **)a_array,
                          (const gint_t *)&lda, (const double **)b_array, (const gint_t *)&ldb,
                          &beta, c_array, (const gint_t *)&ldc, (const gint_t *)&one,
                          (const gint_t *)&batch_size);
...
void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_cgemm_batch_stride>(cgh, [=]() {
            BLIS_Complex8 **a_array = (BLIS_Complex8 **)::malloc(sizeof(BLIS_Complex8 *) * batch_size);
            BLIS_Complex8 **b_array = (BLIS_Complex8 **)::malloc(sizeof(BLIS_Complex8 *) * batch_size);
            BLIS_Complex8 **c_array = (BLIS_Complex8 **)::malloc(sizeof(BLIS_Complex8 *) * batch_size);
            ...
            ::cgemm_batch(&transa_, &transb_, (const gint_t *)&m, (const gint_t *)&n,
                          (const gint_t *)&k, &alpha, (const BLIS_Complex8 **)a_array,
                          (const gint_t *)&lda, (const BLIS_Complex8 **)b_array,
                          (const gint_t *)&ldb, &beta, c_array, (const gint_t *)&ldc,
                          (const gint_t *)&one, (const gint_t *)&batch_size);
...
void gemm_batch(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_zgemm_batch_stride>(cgh, [=]() {
            BLIS_Complex16 **a_array =
                (BLIS_Complex16 **)::malloc(sizeof(BLIS_Complex16 *) * batch_size);
            BLIS_Complex16 **b_array =
                (BLIS_Complex16 **)::malloc(sizeof(BLIS_Complex16 *) * batch_size);
            BLIS_Complex16 **c_array =
                (BLIS_Complex16 **)::malloc(sizeof(BLIS_Complex16 *) * batch_size);
            ...
            ::zgemm_batch(&transa_, &transb_, (const gint_t *)&m, (const gint_t *)&n,
                          (const gint_t *)&k, &alpha, (const BLIS_Complex16 **)a_array,
                          (const gint_t *)&lda, (const BLIS_Complex16 **)b_array,
                          (const gint_t *)&ldb, &beta, c_array, (const gint_t *)&ldc,
                          (const gint_t *)&one, (const gint_t *)&batch_size);
...
void trsm_batch(cl::sycl::queue &queue, cl::sycl::buffer<side, 1> &left_right,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto ldb_acc        = ldb.get_access<cl::sycl::access::mode::read>(cgh);
        auto group_size_acc = group_size.get_access<cl::sycl::access::mode::read>(cgh);
        host_task<class blis_kernel_init_strsm_batch>(cgh, [=]() {
            int64_t total_size = 0;
            ...
            ::strsm_batch(side_, uplo_, trans_, diag_, m_, n_, alpha_acc.get_pointer(),
                          ...
                          (gint_t *)&group_count, group_size_);
...
void trsm_batch(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_strsm_batch_stride>(cgh, [=]() {
            float **a_array = (float **)::malloc(sizeof(float *) * batch_size);
            float **b_array = (float **)::malloc(sizeof(float *) * batch_size);
            ...
            ::strsm_batch(&side_, &uplo_, &trans_, &diag_, (const gint_t *)&m, (const gint_t *)&n,
                          &alpha, (const float **)a_array, (const gint_t *)&lda, (float **)b_array,
                          (const gint_t *)&ldb, (const gint_t *)&one,
                          (const gint_t *)&batch_size);
...
void trsm_batch(cl::sycl::queue &queue, cl::sycl::buffer<side, 1> &left_right,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto ldb_acc        = ldb.get_access<cl::sycl::access::mode::read>(cgh);
        auto group_size_acc = group_size.get_access<cl::sycl::access::mode::read>(cgh);
        host_task<class blis_kernel_init_dtrsm_batch>(cgh, [=]() {
            int64_t total_size = 0;
...
void trsm_batch(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_dtrsm_batch_stride>(cgh, [=]() {
            double **a_array = (double **)::malloc(sizeof(double *) * batch_size);
            double **b_array = (double **)::malloc(sizeof(double *) * batch_size);
            ...
            ::dtrsm_batch(&side_, &uplo_, &trans_, &diag_, (const gint_t *)&m, (const gint_t *)&n,
                          &alpha, (const double **)a_array, (const gint_t *)&lda,
                          (double **)b_array, (const gint_t *)&ldb, (const gint_t *)&one,
                          (const gint_t *)&batch_size);
...
void trsm_batch(cl::sycl::queue &queue, cl::sycl::buffer<side, 1> &left_right,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto ldb_acc        = ldb.get_access<cl::sycl::access::mode::read>(cgh);
        auto group_size_acc = group_size.get_access<cl::sycl::access::mode::read>(cgh);
        host_task<class blis_kernel_init_ctrsm_batch>(cgh, [=]() {
            int64_t total_size = 0;
            ...
            ::ctrsm_batch(side_, uplo_, trans_, diag_, m_, n_, alpha_acc.get_pointer(),
                          (const BLIS_Complex8 **)a_array, lda_, (BLIS_Complex8 **)b_array, ldb_,
                          (gint_t *)&group_count, group_size_);
...
void trsm_batch(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_ctrsm_batch_stride>(cgh, [=]() {
            BLIS_Complex8 **a_array = (BLIS_Complex8 **)::malloc(sizeof(BLIS_Complex8 *) * batch_size);
            BLIS_Complex8 **b_array = (BLIS_Complex8 **)::malloc(sizeof(BLIS_Complex8 *) * batch_size);
            ...
            ::ctrsm_batch(&side_, &uplo_, &trans_, &diag_, (const gint_t *)&m, (const gint_t *)&n,
                          &alpha, (const BLIS_Complex8 **)a_array, (const gint_t *)&lda,
                          (BLIS_Complex8 **)b_array, (const gint_t *)&ldb, (const gint_t *)&one,
                          (const gint_t *)&batch_size);
...
void trsm_batch(cl::sycl::queue &queue, cl::sycl::buffer<side, 1> &left_right,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class blis_kernel_init_ztrsm_batch>(cgh, [=]() {
            int64_t total_size = 0;
            ...
            ::ztrsm_batch(side_, uplo_, trans_, diag_, m_, n_, alpha_acc.get_pointer(),
                          (const BLIS_Complex16 **)a_array, lda_, (BLIS_Complex16 **)b_array, ldb_,
                          (gint_t *)&group_count, group_size_);
...
void trsm_batch(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        char diag_  = *fortran_char(unit_diag);
        gint_t one = 1;
        host_task<class blis_kernel_init_ztrsm_batch_stride>(cgh, [=]() {
            BLIS_Complex16 **a_array =
                (BLIS_Complex16 **)::malloc(sizeof(BLIS_Complex16 *) * batch_size);
            BLIS_Complex16 **b_array =
                (BLIS_Complex16 **)::malloc(sizeof(BLIS_Complex16 *) * batch_size);
            ...
            ::ztrsm_batch(&side_, &uplo_, &trans_, &diag_, (const gint_t *)&m, (const gint_t *)&n,
                          &alpha, (const BLIS_Complex16 **)a_array, (const gint_t *)&lda,
                          (BLIS_Complex16 **)b_array, (const gint_t *)&ldb, (const gint_t *)&one,
                          (const gint_t *)&batch_size);
