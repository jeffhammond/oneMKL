...
bool isfinite(onemkl::blis::fp16 h) {
    return (~h.raw & 0x7C00);
}

onemkl::blis::fp16 abs(onemkl::blis::fp16 h) {
    onemkl::blis::fp16 a = h;
    a.raw &= ~0x8000;
    return a;
}

onemkl::blis::fp16 real(onemkl::blis::fp16 h) {
    return h;
}

float imag(onemkl::blis::fp16 h) {
    return 0.0f;
}

template <>
class numeric_limits<onemkl::blis::fp16> {
public:
    static onemkl::blis::fp16 min() {
        return onemkl::blis::fp16(0x0100, false);
    }
    static onemkl::blis::fp16 lowest() {
        return onemkl::blis::fp16(0xFBFF, false);
    }
    static onemkl::blis::fp16 max() {
        return onemkl::blis::fp16(0x7BFF, false);
    }
    static onemkl::blis::fp16 epsilon() {
        return onemkl::blis::fp16(0x1400, false);
    }
    static onemkl::blis::fp16 round_error() {
        return onemkl::blis::fp16(0x3800, false);
    } // 0.5ulp
    static onemkl::blis::fp16 infinity() {
        return onemkl::blis::fp16(0x7C00, false);
    }
    static onemkl::blis::fp16 quiet_NaN() {
        return onemkl::blis::fp16(0x7D00, false);
    }
    static onemkl::blis::fp16 signaling_NaN() {
        return onemkl::blis::fp16(0x7E00, false);
    }
    static onemkl::blis::fp16 denorm_min() {
        return onemkl::blis::fp16(0x0001, false);
    }
};
